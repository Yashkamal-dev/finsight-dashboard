    ...
    <div>
      ...
      {(all || inProgress) && (
        <div className="my-0 md:my-2">
          ...
          <header className="flex justify-between border-b border-b-[var(--border-default)] py-3 text-base md:text-lg">
            <h1 className="text-[var(--text-secondary)]">In progress</h1>
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(340px,1fr))] items-start gap-4 py-5 md:gap-7 md:py-7">
      ...
      {(all || completed) && (
        <div className="my-0 md:my-2">
          ...
          <header className="flex justify-between border-b border-b-[var(--border-default)] py-3 text-base md:text-lg">
            <h1 className="text-[var(--text-secondary)]">Completed</h1>
            <span className="text-[var(--text-secondary)]">
      ...
      {(all || notStarted) && (
        <div className="my-0 md:my-2">
          ...
          <header className="flex justify-between border-b border-b-[var(--border-default)] py-3 text-base md:text-lg">
            <h1 className="text-[var(--text-secondary)]">Not started</h1>
            <span className="text-[var(--text-secondary)]">
