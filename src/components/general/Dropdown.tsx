  ...
  return (
    ...
    <div className="relative">
      ...
      <div
        ...
        className={`flex items-center text-sm transition-all duration-200 ease-in md:text-base ${error === true ? "border-[var(--danger)]" : ""} min-w-fit cursor-pointer rounded-full border border-[var(--border-default)] py-1 text-center shadow-md hover:bg-[var(--accent-subtle)] md:min-w-40 md:py-1.5 md:shadow-xl`}
      >
